            ...
            <div class="flex flex-row-reverse items-center">
                ...
                <div class="dropdown relative md:static">
                    ...
                    <div
                        ...
                        <!-- item -->
                        <form action="{{ route('logout') }}" method="post" class="px-4 py-2 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 hover:text-gray-900 transition-all duration-300 ease-in-out">
                            @csrf
                            <button type="submit" >
                    ...
                    <div
                        ...
                        <a class="flex flex-row items-center justify-start px-4 py-4 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 transition-all duration-300 ease-in-out"
                            ...
                            <div class="w-10 h-10 rounded-full overflow-hidden mr-3 bg-gray-100 border border-gray-300">
                                <img class="w-full h-full object-cover" src="{{ asset('admin/img/user1.jpg') }}"
                                    alt="">
                            </div>
                        ...
                        <a class="flex flex-row items-center justify-start px-4 py-4 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 transition-all duration-300 ease-in-out"
                            ...
                            <div class="w-10 h-10 rounded-full overflow-hidden mr-3 bg-gray-100 border border-gray-300">
                                <img class="w-full h-full object-cover" src="{{ asset('admin/img/user2.jpg') }}"
                                    alt="">
                            </div>
                        ...
                        <a class="flex flex-row items-center justify-start px-4 py-4 block capitalize font-medium text-sm tracking-wide bg-white hover:bg-gray-200 transition-all duration-300 ease-in-out"
                            ...
                            <div
                                ...
                                <img class="w-full h-full object-cover" src="{{ asset('admin/img/user3.jpg') }}"
                                    alt="">
                            </div>
